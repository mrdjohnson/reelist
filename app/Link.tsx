...
// export const NextLinkComposed = React.forwardRef<HTMLAnchorElement, NavLinkProps>(
...
//     [activeClassName]: router(pathname, { replace: true }).pathname === pathname && activeClassName,
//   })

...
export class TmdbOpenGraphFormatter {
  static async fromVideo(video?: TmdbVideoType | null): Promise<OpenGraphType | null> {
  ...
  static async fromPerson(person?: TmdbPersonType | null): Promise<OpenGraphType | null> {

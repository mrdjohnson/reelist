...
import ReelistSelect from './ReelistSelect'
          ...
          <div className="discover-md:mb-5 flex h-12 flex-row gap-2">
            <div className=" border-reelist-red mb-2 flex h-12 w-full flex-row items-baseline border-0 border-b border-solid ">
              ...
              {searchText && showSearchBubble ? (
                ...
                <input
                  className="focus:shadow-outline discover-md:leading-[35px] outline-hidden w-full appearance-none border-0 bg-transparent py-2 text-xl leading-[30px] text-gray-300 shadow"
                  type="text"
                  autoComplete="off"
                  placeholder="Search"
            ...
            header={
              <>
                ...
                <div className="left-0 right-0 top-0 bg-black">
                  <input
                    className="focus:shadow-outline border-reelist-red outline-hidden mb-4 w-full appearance-none border-0 border-b bg-transparent py-2 text-lg leading-tight text-gray-300 shadow"
                    type="text"
                    autoComplete="off"

...
const EntityImage = observer(
  ({
    ...
    const genres = useMemo(() => {
      // TODO: the tmdbDiscover.genreSelectState.optionsLoaded check should happen in the parent component
      ...
      >
        {source ? (
          <img
            ...
            className={twMerge(
              isPoster && 'aspect-poster h-fit max-h-[609px] min-h-[400px] object-contain',
              !isPoster &&
          ...
          <div
            className={twMerge(
              'flex flex-1 justify-center bg-slate-500 text-black',
              isPoster && 'min-h-[400px] items-center',
              isPoster && !source && 'aspect-poster  max-h-[609px]',
              className,
            )}
          >
